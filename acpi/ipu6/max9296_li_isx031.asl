 ...
 *
 * SSDT overlay: Leopard Imaging (LI) ISX031 GMSL camera configuration with MAX9296A deserializer on ARL platform.
 *   One MAX9296A deserializer (DES0) with DPHY connection to ARL platform,
